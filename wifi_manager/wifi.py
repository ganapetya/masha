...
if __name__ == "__main__":
    ...
    def WIFI_MGR():
        ...
        if WIFI_MODE == 1: #AP
            ...
            # 强制指定频段和信道  增加了 802-11-wireless.band 和 802-11-wireless.channel
            cmd_modify = (
                'nmcli con modify {0} '
                '802-11-wireless.mode ap '
                '802-11-wireless.band {1} '
                '802-11-wireless.channel {2} '
                'ipv4.method shared '
                'ipv4.addresses {3}/24 '
                ...
                'wifi-sec.group tkip '
                'wifi-sec.psk {4}'
            ).format(WIFI_AP_SSID, WIFI_FREQ_BAND, WIFI_CHANNEL, WIFI_AP_GATEWAY, WIFI_AP_PASSWORD)
