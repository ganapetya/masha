...
class MainWindow(QWidget, ui.Ui_Form):
    def __init__(self):
        ...
        depth_camera_list = ['aurora', 'usb_cam' ]
        lidar_list = ['LD19']
        machine_list = ['ROSpider']
        language_list = ['Chinese', 'English']
        mic_type_list = ['xf', 'WonderEchoPro']
        asr_mode_list = ['online', 'offline']
    ...
    def get_hw(self):
        ...
        HW_WIFI_AP_SSID = ''.join(["WN-", serial_num[0:8]])
    ...
    def get_typerc(self):
        with open(self.typerc_path, "r") as f:
            ...
            self.asr_mode = re.findall(r'export ASR_MODE.*?\n', data)[0].split('=')[1].replace('\n', '')
    ...
    def set_typerc(self):
        with open(self.typerc_path, "r") as f:
            ...
            data = data.replace("=" + self.asr_mode, "=" + asr_mode)
